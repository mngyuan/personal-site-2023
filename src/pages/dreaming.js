...
const Dreaming = () => {
  return (
    <SharedLayout>
      ...
      <Row>
        <br />
        <br />I spent two months wandering Asia alone in 2019, meditating in the
        incredibly personal mental space a language and culture barrier creates.
        Crowded public spaces took on a dream-like quality, as if they existed
        solely for myself as places to both confront and embrace a surreal
        familiarity - the familiarity of a First Home, experienced through
        memories of color and spice and foreign tongues spoken in adopted homes.
        The East is at once immediate and inaccessible, a place imagined but
        never fathomed in its whole, its realities and complexities a sensory
        overload for those who have long walked the lonesome path of diaspora.
      </Row>
      <Row
        left={
          <Image
      ...
      >
        ...
        empty chords within me: the jade of faded ads, the soft filtered gold of
        the Asian sun, the screams of neon, the gaudy brilliance of bus sides
        and bus seats, the piercing blue of the shadows cast by salarymen and
        their briefcases, the eggshell white and cream of the lines drawn on the
        regal Toyota Crown.
      </Row>
    </SharedLayout>
  );
