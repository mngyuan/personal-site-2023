  ...
  return (
    <>
      <main className="h-full overflow-auto flex flex-col justify-between">
        ...
        <div className="basis-1/2 shrink-0 grow-0 p-6 pl-12 pb-0 pr-2/7">
          image
        </div>
        ...
        <div className="basis-1/2 shrink-0 grow-0 flex flex-row justify-between items-start">
          <div className="p-6 pl-12 pb-0">image</div>
      ...
      <div className="h-full w-2/7 top-0 left-5/7 absolute flex flex-col justify-between">
