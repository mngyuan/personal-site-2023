      ...
      <SharedLayout>
        <div className="h-1/2 basis-1/2 shrink-0 grow-0 flex flex-row justify-between items-start">
          ...
          <motion.div
            ...
            custom={[10]}
          >
            Video editing today lives almost entirely digitally, behind thumb
            taps or mouse clicks and keyboard shortcuts. What if the work of
            editing wasn’t hidden behind software interfaces, and their workflow
            of constant interruption and stopping and starting?
          </motion.div>
        </div>
        <div className="h-1/2 basis-1/2 shrink-0 grow-0 flex flex-row justify-between items-start">
        ...
        <div className="h-1/2 basis-1/2 shrink-0 grow-0 flex flex-row justify-between items-start">
          ...
          <div className="w-2/7 pt-6 pl-6 pr-12 sticky top-blurb">
            ...
            expressiveness, but in their ability to embody cognitive processes.
            By encouraging play, creativity, and experimentation, and by
            breaking out of a purely software interaction space, we might enable
        ...
        <div className="h-1/2 basis-1/2 shrink-0 grow-0 flex flex-row justify-between items-start">
          ...
          <div className="w-2/7 pt-6 pl-6 pr-12 sticky top-blurb">
            ...
            basis for entire new genres of sound, an accessible approach to
            video editing could revolutionize visual storytelling. That is the
            spirit behind MX-CLP, a portable, all-in-one video editing device
            which inspires creatives to find new stories to tell.
          </div>
        </div>
      </SharedLayout>
    </PageTransition>
...
export default forwardRef(MXCLP);
